...
export default function About() {
  return (
    <main>
      <section className="page page-hero"><div className="pill">About Green Basket</div><h1>We make digital work easier to manage.</h1><p className="page-lead">Green Basket Global Limited helps organizations access and manage the technology they need without carrying all of the technical burden themselves.</p></section>
